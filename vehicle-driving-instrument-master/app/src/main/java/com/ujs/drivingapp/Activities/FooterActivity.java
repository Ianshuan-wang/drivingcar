...
public class FooterActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        FullScreenUtil.setFullScreen(FooterActivity.this);

        mapService = new RetrofitUtil.Builder(FooterActivity.this).setClient().build(MapService.class);
        initMap();
    ...
    private void initMap() {
        ...
        try {
            ...
            poiSearchId = new PoiSearch(FooterActivity.this, null);
            poiSearchId.setOnPoiSearchListener(new PoiSearch.OnPoiSearchListener() {
                ...
                public void onPoiItemSearched(PoiItem poiItem, int i) {
                    ...
                    options.icon(BitmapDescriptorFactory.fromResource(R.drawable.ic_poi_marker_footer));
            ...
            Call<ResponseBody> call = mapService.getAllFooter();
            call.enqueue(new Callback<ResponseBody>() {
                @Override
                public void onResponse(Call<ResponseBody> call, Response<ResponseBody> response) {
                    try {
