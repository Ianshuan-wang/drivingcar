 ...
 * @create time 1/27/2022 8:27 PM.
 * @description 自定义饼图渲染类
 */
...
public class CustomizedPieChartRenderer extends DataRenderer {

    protected CustomizedPieChart mChart;
    ...
    public CustomizedPieChartRenderer(CustomizedPieChart chart, ChartAnimator animator,
            ...
            for (int j = 0; j < entryCount; j++) {
                ...
                if (drawXOutside || drawYOutside) {
                    ...
                    if (drawXOutside && drawYOutside) {
                        ...
                        drawValue(c, entry.getLabel(), labelPtx, labelPty + lineHeight / 2.f, valueColor);
                    }
                }
                ...
                if (drawXInside || drawYInside) {
                    ...
                    if (drawXInside && drawYInside) {
                        ...
                        drawValue(c, entry.getLabel(), x, y, dataSet.getValueTextColor(j));
                        ...
                        drawValue(c, entry.getLabel(), x, y + lineHeight / 2f, dataSet.getValueTextColor(j));
                    }
                }
